...
class AppConfig {
  static String copyright_text = "@ Sam & Ram Pharmacies" + this_year; //this shows in the splash screen
  static String app_name = "Sam & Ram Pharmacies"; //this shows in the splash screen
  static String purchase_code = "<Your purchase code for flutter app>"; //enter your purchase code for the app from codecanyon
  ...
  //configure this
  static const DOMAIN_PATH = "samandram.com/"; //localhost
