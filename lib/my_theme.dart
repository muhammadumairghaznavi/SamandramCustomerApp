...
class MyTheme{
  ...
  static Color accent_color = Color.fromRGBO(58, 88, 116, 1.0);
  static Color soft_accent_color = Color.fromRGBO(50, 192, 105, 1);
  static Color splash_screen_color = Color.fromRGBO(58, 88, 116, 1.0); // if not sure , use the same color as accent color
  ...
  static Color shimmer_highlighted = Coasdlors.yellow;*/
